package com.alium.nibo.autocompletesearchbar.animation;

import android.view.animation.Interpolator;

import java.lang.ref.WeakReference;

public abstract class BaseSupportAnimator {

    WeakReference<CircularRevealAnimator> mTarget;

    public BaseSupportAnimator(CircularRevealAnimator target) {
     ...
     */
    public BaseSupportAnimator reverse() {
        if(isRunning()){
            return null;
        }

        CircularRevealAnimator target = mTarget.get();
        if(target != null){
